...
def parse_arge():
    ...
    # )
    parser.add_argument("--pretrain_model_path", type=str, default="google/flan-t5-xl", help="Path to pretrained model")
...
def training_function(args):
    ...
    print(f"dataset_list: {os.listdir(args.dataset_path)}")
    print(f"pretrained_model_list: {os.listdir(args.pretrain_model_path)}")    
    print("-------------------------------------")
